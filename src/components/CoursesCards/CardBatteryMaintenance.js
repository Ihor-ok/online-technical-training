...
import img from '../../img/BatteryMaintenance.jpg'
import { Link } from 'react-router-dom';

export default function CardBatteryMaintenance () {
  ...
  return (
    ...
    <Card sx={{position: 'relative', maxWidth: '365px', minHeight: '450px', margin: '10px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }} >
      <Link to={`/courses/battery_maintenance`} style={{ textDecoration: 'none', color: 'inherit', flexGrow: 1 }}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="240"
        ...
        <CardContent>
          <Typography gutterBottom variant="h5" component="div">
            Battery Maintenance Basics woT (BMB Online) ENG 
          </Typography>
