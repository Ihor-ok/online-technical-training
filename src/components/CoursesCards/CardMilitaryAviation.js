...
import img from '../../img/MilitaryAviation.jpg'
import { Link } from 'react-router-dom';

export default function CardMilitaryAviation() {
  ...
  return (
    ...
    <Card sx={{position: 'relative', maxWidth: '365px', minHeight: '450px', margin: '10px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }} >
      <Link to={`/courses/military_aviation_legislation`} style={{ textDecoration: 'none', color: 'inherit', flexGrow: 1 }}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="240"
